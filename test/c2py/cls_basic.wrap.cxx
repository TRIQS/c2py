...
template <> inline constexpr bool c2py::is_wrapped<A>           = true;
template <> inline constexpr bool c2py::is_wrapped<dummy_class> = true;
...
// do_thing
static auto const fun_4   = c2py::dispatcher_f_kw_t{c2py::cfun(c2py::castm<double>(&dummy_class::do_thing), "x")};
static const auto doc_d_4 = fun_4.doc({R"DOC(   )DOC"});

// ----- Method table ----
template <>
PyMethodDef c2py::tp_methods<dummy_class>[] = {
   {"do_thing", (PyCFunction)c2py::pyfkw<fun_4>, METH_VARARGS | METH_KEYWORDS, doc_d_4.c_str()},
   {nullptr, nullptr, 0, nullptr} // Sentinel
};
...
// a_friend
static auto const fun_5 = c2py::dispatcher_f_kw_t{c2py::cfun([](const A &a) { return a_friend(a); }, "a")};

// hhh
static auto const fun_6 = c2py::dispatcher_f_kw_t{c2py::cfun(c2py::cast<const A &, int>(&hhh), "a", "j")};

// maker_A
static auto const fun_7 = c2py::dispatcher_f_kw_t{c2py::cfun(c2py::cast<int>(&maker_A), "i")};
...
static PyMethodDef module_methods[] = {
   {"a_friend", (PyCFunction)c2py::pyfkw<fun_5>, METH_VARARGS | METH_KEYWORDS, doc_d_5.c_str()},
   {"hhh", (PyCFunction)c2py::pyfkw<fun_6>, METH_VARARGS | METH_KEYWORDS, doc_d_6.c_str()},
   {"maker_A", (PyCFunction)c2py::pyfkw<fun_7>, METH_VARARGS | METH_KEYWORDS, doc_d_7.c_str()},
   {nullptr, nullptr, 0, nullptr} // Sentinel
};
...
extern "C" __attribute__((visibility("default"))) PyObject *PyInit_cls_basic() {
  ...
  if (PyType_Ready(&c2py::py_type_object<A>) < 0) return NULL;
  if (PyType_Ready(&c2py::py_type_object<dummy_class>) < 0) return NULL;
