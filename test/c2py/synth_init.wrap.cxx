...
template <> inline constexpr bool c2py::is_wrapped<N1::A_ndc>      = true;
template <> inline constexpr bool c2py::is_wrapped<N1::params>     = true;
template <> inline constexpr bool c2py::is_wrapped<N1::params_ndc> = true;
...
extern "C" __attribute__((visibility("default"))) PyObject *PyInit_synth_init() {
  ...
  if (PyType_Ready(&c2py::py_type_object<N1::A_ndc>) < 0) return NULL;
  if (PyType_Ready(&c2py::py_type_object<N1::params>) < 0) return NULL;
  if (PyType_Ready(&c2py::py_type_object<N1::params_ndc>) < 0) return NULL;
