...
// f
static auto const fun_1 = c2py::dispatcher_f_kw_t{c2py::cfun(c2py::cast<std::array<int, 3>>(&f), "")};

// g
static auto const fun_2 = c2py::dispatcher_f_kw_t{c2py::cfun(c2py::cast<const std::array<int, 3> &>(&g), "")};

// h
static auto const fun_3 = c2py::dispatcher_f_kw_t{c2py::cfun(c2py::cast<std::array<int, 3>>(&h), "")};
