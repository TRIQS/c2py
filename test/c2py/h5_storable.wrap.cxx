...
template <> inline constexpr bool c2py::is_wrapped<storable> = true;
...
template <>
constinit PyGetSetDef c2py::tp_getset<storable>[] = {
   c2py::getsetdef_from_member<&storable::vec, storable>("vec", doc_member_0),
...
extern "C" __attribute__((visibility("default"))) PyObject *PyInit_h5_storable() {
  ...
  if (PyType_Ready(&c2py::py_type_object<storable>) < 0) return NULL;
